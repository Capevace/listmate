	...
	return (
		<article className="mx-auto flex w-full max-w-7xl flex-col gap-5 pt-20">
			<header className="flex w-full flex-col gap-4 ">
				...
				></div>
				<div className="absolute top-0 left-0 right-0 h-64 bg-gradient-to-b from-transparent to-theme-900"></div>

				<div className="z-10 flex w-full items-center justify-between">
					<section className="flex flex-1 flex-col font-medium text-theme-100">
						<h1>Page name</h1>
						<p className="text-sm text-theme-400">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit.
						</p>
					</section>
					<nav className="z-10 flex items-center justify-end text-theme-300">
						<button>
				...
				<hr className="z-10 border-theme-400" />
			</header>
			<main className="z-10">
				<h2>Hello</h2>
			</main>
